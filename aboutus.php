...
.three{
  margin-left: 60%;
  margin-top: 5px;
  box-shadow:0px 0px 15px #E05D1E;
}
    td{
        text-align: center;
    }
...
<body>
      ...
      <div class="nav">
        <ul>
          ...
          <li><a style="background-color: #E05D1E" href="aboutus.php">ABOUT US</a>
          </li>
  ...
  <div class="boxtwo" style="border:solid 1px #CF0403;border-radius: 10px; width:84%; height:850px; margin-left:10%;margin-top:10px;background-color:white">
      ...
      <h1 style="color:black;text-align:center;background:rgba(255, 255, 255, 0.24)">ABOUT OUR  LIBRARY MANAGEMENT SYSTEM PROJECT </h1>
...
:30%;background:rgba(0, 0, 0, 0.5);box-shadow:0px 0px 20px #fc7af7;border-radius:10px;padding:3%;font-size:15px;height:200px;"><marquee direction="up" scrolldelay="200" >
         ...
         <tr><td><br/></td><td>1. M.I.F. Safa MA-DSE-201-F-044  </td><td><br/></td><td> Role = ( GROUP LEADER + USER PANEL DEVELOPED )
         <br>Hotline: +94711416007</td><td><br/></td></tr>
            
            <br/>
            <hr>
          
          
         <tr><td><br/></td><td>2. Asna Azwar  MA-DSE-201-F-050</td><td><br/></td><td>Role  = ( ADMIN PANEL + USER PANEL DEVELOPED  )
